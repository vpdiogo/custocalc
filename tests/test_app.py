...
def test_calculate_without_plan():
    for i, j, k in zip(range(50), range(50), range(50)):
        assert (
            type(calculate_without_plan(i, j, k)) == str
            and calculate_without_plan(i, j, k) is not None
        )
...
def test_calculate_plan_30():
    for i, j, k in zip(range(50), range(50), range(50)):
        assert (
            type(calculate_plan_30(i, j, k)) == str
            and calculate_plan_30(i, j, k) is not None
        )
...
def test_calculate_plan_60():
    for i, j, k in zip(range(50), range(50), range(50)):
        assert (
            type(calculate_plan_60(i, j, k)) == str
            and calculate_plan_60(i, j, k) is not None
        )
...
def test_calculate_plan_120():
    for i, j, k in zip(range(50), range(50), range(50)):
        assert (
            type(calculate_plan_120(i, j, k)) == str
            and calculate_plan_120(i, j, k) is not None
        )
